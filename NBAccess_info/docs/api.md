...
Options: "AccessSpec" -> `<|"AccessLevel" -> 0.7|>`, "DryRun" -> True, "MaxResults" -> All
...
Options: "AccessSpec" -> `<|"AccessLevel" -> 0.7|>`, "DryRun" -> True
...
Options: "AccessSpec" -> `<|"AccessLevel" -> 0.7|>`, "DryRun" -> False
...
戻り値: `<|"ReadCells", "WriteCells", "RequiredAccessLevel", "HasSideEffects" -> True|False, ...|>`
